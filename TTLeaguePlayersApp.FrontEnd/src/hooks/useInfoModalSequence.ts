 ...
 * suppressible. `guids` must be a module-scope constant: the returned callbacks depend on its
 * reference identity, so a fresh array literal on every render would defeat the memoisation.
 *
