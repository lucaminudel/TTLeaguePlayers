 ...
 */
export async function getCachedPlayerKudos(request: GetKudosRequest): Promise<KudosResponse[]> {
 ...
 */
export async function getCachedTeamKudos(request: GetTeamKudosRequest): Promise<KudosSummaryResponse[]> {
 ...
 */
export async function getCachedKudosStandings(request: GetKudosStandingsRequest): Promise<KudosStandingsResponse> {
